...
| `numeric_short` | 01/68 | ตัวเลข MM/YY พ.ศ. (สำหรับ Chart) |
| `numeric_full` | 14/01/2568 | ตัวเลข DD/MM/YYYY พ.ศ. (สำหรับวันที่เต็ม) |
...
**แนะนำ:** `th_short_be_short` → "ม.ค. 68" หรือ `numeric_short` → "01/68"
- ✅ ประหยัดพื้นที่
- ✅ เหมาะกับ chart ที่มีข้อมูลเยอะ
- ✅ `numeric_short` เหมาะกับ chart ที่ต้องการความกระชับสูงสุด
...
**แนะนำ:** `numeric_full` → "14/01/2568"
- ✅ ใช้กับ Lead Time Analysis และรายงานที่ต้องการวันที่เต็ม
- ✅ รูปแบบตัวเลขอ่านง่าย เข้าใจสากล
- ✅ ประหยัดพื้นที่กว่าเดือนตัวอักษร
...
✅ **รองรับ 10 รูปแบบ** - เดือนไทย/อังกฤษ (เต็ม/ย่อ) + ปี พ.ศ./ค.ศ. (เต็ม/ย่อ) + รูปแบบตัวเลข (MM/YY และ DD/MM/YYYY)  
