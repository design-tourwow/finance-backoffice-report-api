...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    let query = 'SELECT * FROM tw_suppliers_db_views.v_GsF2WeS_suppliers WHERE 1=1'
    const params: any[] = []
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const query = `INSERT INTO tw_suppliers_db_views.v_GsF2WeS_suppliers (${fields}, created_at, updated_at) VALUES (${placeholders}, NOW(), NOW())`
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    const query = `UPDATE tw_suppliers_db_views.v_GsF2WeS_suppliers SET ${setClause}, updated_at = NOW() WHERE id = ?`
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    const query = 'DELETE FROM tw_suppliers_db_views.v_GsF2WeS_suppliers WHERE id = ?'
